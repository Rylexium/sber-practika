...
public class TransferPhoneController {
    ...
    public Object phoneToBankNumber(@RequestBody TransferRequestPhoneToBankNumber request) {
    ...
    public Object bankCardToBankCard(@RequestBody TransferRequestPhoneToBankCard request) {
    ...
    public Object bankCardToBankCard(@RequestBody TransferRequestPhoneToPhone request) {
