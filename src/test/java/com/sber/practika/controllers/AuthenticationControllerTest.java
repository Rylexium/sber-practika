...
class AuthenticationControllerTest {
    ...
    void testAuthenticationByPhone() {
        ...
        try {
            ...
            data.add(new JSONObject()
                    .put("phone", "85068407595") //false номер телефона
                    .put("password", "95a81899484bec3b5a087bf9649996eba4856a5c673358b0a0e2e93715662dfc"));
            data.add(new JSONObject()
                    .put("phone", "85068407596") // true
                    .put("password", "95a81899484bec3b5a087bf9649996eba4856a5c673358b0a0e2e93715662dfc"));
            data.add(new JSONObject()
                    .put("phone", "89371727345") //false пароль
                    .put("password", "c7ac64c7b729900c2004008dc0f78a763038e97fb22249eb2a38d3628fef754a"));
